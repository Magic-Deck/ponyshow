      ...
      rimraf(workspace+'/themes/'+name, function(){
        ...
        isOnline(function(online) {
          ...
          if (online) {
            ...
            spinner.setText('%s Downloading latest theme');
              ...
              if (!error && response.statusCode == 200) {
                ...
                request.get(opts)
                  ...
                  .on('end',function() {
                    ...
                    // update default
                    spinner.setText('%s Merging properties');
                    ...
                    var read1 = fs.createReadStream(fscopyright)
                      .pipe(replaceStream('<%= author %>', pkg.author))
                    ...
                    var read3 = fs.createReadStream(fsreadme)
                      .pipe(replaceStream('<%= name %>', pkg.author))
            ...
            console.log('Sorry, not online. You must have internet access to bootstrap themes.');
            process.exit(0);
